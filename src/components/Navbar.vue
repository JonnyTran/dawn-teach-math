...
<template>
  ...
  <Navbar v-if="showCoursesSubmenu && sectionId && sections && sectionId in sections">
    <template #logo>
...
<script>
import { Navbar, NavbarLogo, NavbarCollapse, NavbarLink, Dropdown, ListGroup, ListGroupItem, Tooltip } from 'flowbite-vue';
import { ref } from 'vue';
