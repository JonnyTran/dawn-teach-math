<template>
  <div
    style="margin-block-start: 5%"
    class="mx-auto p-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"
  >
      ...
      <div class="flex items-start">
        <div class="flex items-center h-5">
          <input
            ...
            type="checkbox"
            value=""
            class="w-4 h-4 border border-gray-300 rounded bg-gray-50 hover:point focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800"
            required
          />
        </div>
        <label for="sendcopy" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
        ...
        >
          <svg
            class="ml-20 mt-0.5 w-4 h-4 text-gray-400 hover:text-gray-500"
            aria-hidden="true"
            fill="currentColor"
            viewBox="0 0 20 20"
